//Thu May 14 2026 08:59:51 GMT+0000 (Coordinated Universal Time)
...
class _0x35e111 extends _0x55ea0b {
  ...
  async teamDetail(_0x629a6d = {}) {
    ...
    try {
      ...
      if (_0x49cd1d.BaouM(_0x873253, 0)) {
        let {
          hasTeam: _0xfa23dd,
          teamSize: _0x2f9c21,
        ...
        _0xfa23dd ? (this.teamCode = _0x25a0c0, this.need_help_team_count = _0x2f9c21, this.helped_team_count = _0x278558.length, _0x49cd1d.UuoPa(this.need_help_team_count, this.helped_team_count) ? this.need_help_team = true : this.need_help_team = false) : await this.createTeam();
        this.log("组队进度: " + this.helped_team_count + "/" + this.need_help_team_count);
      } else {
        let _0x4dcf57 = _0x454ec0.get(_0x4a4e26, _0x49cd1d.vflbn, "");
  ...
  async joinTheParty(_0x4fe00d, _0x359bba = {}) {
    ...
    _0x4d140b.brbKJ = "joinTheParty";
    _0x4d140b.AWFOV = function (_0x3797e9, _0x548b4e) {
      return _0x3797e9 == _0x548b4e;
    };
    _0x4d140b.UEdZF = function (_0x4a8b55, _0x20519c) {
      return _0x4a8b55 >= _0x20519c;
    };
    _0x4d140b.qFvmh = "message";
    _0x4d140b.jLRdH = "队伍人数已达上限";
    ...
    try {
      ...
      if (_0x2fab10.AWFOV(_0xbb601a, 0)) {
        this.can_join_team = false;
        this.log("加入[" + _0x20a96c + "]队伍成功");
        _0x4fe00d.helped_team_count++;
        _0x2fab10.UEdZF(_0x4fe00d.helped_team_count, _0x4fe00d.need_help_team_count) && (_0x4fe00d.need_help_team = false, _0x4fe00d.log("组队已完成"));
      } else {
        let _0x3095d5 = _0x454ec0.get(_0x131869, _0x2fab10.qFvmh, "");
        this.log("加入[" + _0x20a96c + "]队伍失败[" + _0xbb601a + "]: " + _0x3095d5);
        if (_0x3095d5?.["includes"](_0x2fab10.jLRdH)) {
...
async function _0x1976a1(_0x4d12f6 = 0) {
  ...
  try {
    ...
    _0x431c3e.fn = "auth";
    _0x431c3e.method = "get";
    _0x431c3e.url = _0x13f210;
    _0x431c3e.timeout = 20000;
